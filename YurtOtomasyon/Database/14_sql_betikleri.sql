...
CREATE TABLE Izinler (
    ...
    DonusTarihi DATE NOT NULL,
    Aciklama NVARCHAR(150) NULL,
    CONSTRAINT FK_Izinler_Ogrenciler FOREIGN KEY (OgrenciID) REFERENCES Ogrenciler(OgrenciID) ON DELETE CASCADE,
    CONSTRAINT CK_Izinler_Tarih CHECK (DonusTarihi >= CikisTarihi)
);
GO
...
BEGIN
    IF EXISTS (
        ...
        WHERE o.OgrenciSayisi + x.Adet > o.Kapasite
    )
    BEGIN
        RAISERROR('Oda kapasitesi dolu oldugu icin ogrenci eklenemez.', 16, 1);
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM Odalar WHERE OdaID = @OdaID AND OgrenciSayisi >= Kapasite)
    BEGIN
        RAISERROR('Secilen odanin kapasitesi doludur.', 16, 1);
        RETURN;
    END;
...
INSERT INTO Izinler (OgrenciID, CikisTarihi, DonusTarihi, Aciklama) VALUES
(1, '2026-06-07', '2026-06-09', N'Aile ziyareti'),
(2, '2026-06-08', '2026-06-10', N'Memleket ziyareti'),
(3, '2026-06-12', '2026-06-15', N'Bayram tatili'),
(4, '2026-06-13', '2026-06-14', N'Hafta sonu izni'),
(5, '2026-06-14', '2026-06-16', N'Akraba ziyareti'),
(6, '2026-06-15', '2026-06-17', N'Aile ziyareti'),
(7, '2026-06-18', '2026-06-20', N'Memleket ziyareti'),
(8, '2026-06-19', '2026-06-21', N'Hafta sonu izni'),
(9, '2026-06-22', '2026-06-24', N'Bayram tatili'),
(10, '2026-06-25', '2026-06-27', N'Aile ziyareti');
